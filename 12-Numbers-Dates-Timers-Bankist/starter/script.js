...
console.log(Math.ceil(23.9)); //round up always
console.log(Math.ceil(23.3));

console.log(Math.floor(23.9)); //round down always
console.log(Math.floor(23.3));

// Rounding decimals
console.log((2.7).toFixed(0)); // Returns string
console.log((2.235).toFixed(2));
console.log(+(2.235).toFixed(2)); //To turn to number

//Remainder (modolo)
console.log(5 % 2);

console.log(6 % 2);
// dividing by 2 should result in 0 remainder if even
...
console.log(new Date('Apr 16 2024 17:06:12'));
